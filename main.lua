      ...
      sprites.player_1d = love.graphics.newImage ('sprites/333_1.png')
        sprites.player_1 = love.graphics.newImage ('sprites/555_1.png')
          sprites.player_1a = love.graphics.newImage ('sprites/222_1.png')
           sprites.playeranim1s = love.graphics.newImage('sprites/playerst.png')
              sprites.player1animm = love.graphics.newImage('sprites/playervlev.png')
              sprites.playerani = love.graphics.newImage('sprites/playervprav.png')
              sprites.playeran = love.graphics.newImage('sprites/s2.png')
                  sprites.playeranh = love.graphics.newImage('sprites/99jj.png')
